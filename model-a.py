...
history = cnn.fit(training_set, epochs=6, validation_data=test_set, shuffle=True, validation_steps=len(test_set))
#history = cnn.fit_generator(training_set, validation_data = test_set, epochs=3)
